...
import (
	...
	// "github.com/evmos/evmos/v14/app/upgrades/upgrade"
    	myupgrade "github.com/Wakar473/upgrade"
...
func (app *Evmos) setupUpgradeHandlers() {
	// //copyright wakar upgrade handler
	app.UpgradeKeeper.SetUpgradeHandler(
		myupgrade.UpgradeName,
		myupgrade.CreateUpgradeHandler(
